...
const input_i_1 = document.querySelector('.i-1');
const div1 = document.querySelector('.out-1');
function f1(){
     let sum = input_i_1.value;
     if (sum == 4){
        div1.innerHTML = true ;
        input_i_1.value = '';
     }
...
const input3 = document.querySelector('.i-31');
const input31 = document.querySelector('.i-32');
...
const input71 = document.querySelector('.i-72');
...
switch(+select8.value){
    case 1: div8.innerHTML = "one" ; break;
    case 2: div8.innerHTML = "two" ; break;
    case 3: div8.innerHTML = "three" ; break;
}
}
...
function f10(){
    div10.innerHTML = select10.value;
}
...
function f11(){
    div11.innerHTML = select11.value;
}
...
const input14 = document.querySelector('.i-141');
const input141 = document.querySelector('.i-142');
const select14 = document.querySelector('.s-143');
const div14 = document.querySelector('.out-14');
function f14(){
    let a = +input14.value;
    let b = +input141.value;
    let c = select14.value;
    switch(c){
        case '+': div14.innerHTML = a + b; break;
        case '-': div14.innerHTML = a - b; break;
        case '*': div14.innerHTML = a * b; break;
        case '/': div14.innerHTML = a / b; break;
    }
...
const select15 = document.querySelector('.s-151');
const select151 = document.querySelector('.s-152');
const select152 = document.querySelector('.s-153');
const div15 = document.querySelector('.out-15');
function f15(){
let a = +select15.value;
let b = +select151.value;
let c = select152.value;
switch(c){
    case '&&': div15.innerHTML = a && b ; break;
    case '||': div15.innerHTML = a || b ; break;
}
}
