...
function t4() {
    const a = document.querySelector('.out-4');
    let b = "";
...
function t5() {
const a = document.querySelector('.out-5');
let b = "";
for(let i = 1; i <=17 ; i++){
b+=i+"_*";
}
...
function t6() {
 ...
 let b = document.querySelector('.i-6');
 let c = "";
...
function t7() {
 const a = document.querySelector('.out-7');
 let b = '';
 let c = document.querySelector('.i-7');
 for(let i = c.value ; i >= 0 ; i--){
    b+=i + " ";
 }
 a.innerHTML = b;
}
...
function t8() {
 ...
 const c = document.querySelector('.out-8');
 let d = "";
